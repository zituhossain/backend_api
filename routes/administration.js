...
router.get('/place_comment_by_district/:id',auth, AdministrationController.getplacecommentbydistrictid);
router.get('/place_comment_by_division/:id',auth, AdministrationController.getplacecommentbydivisionid);
...
router.get('/get_administration_officer',auth, AdministrationController.getadministration_officer);
